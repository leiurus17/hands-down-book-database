...
if ((isset($_POST['hiddenField'])) && ($_POST['hiddenField'] != "")) {
  $deleteSQL = sprintf("DELETE FROM book_information WHERE ISBN=%s",
...
<table width="80%" border="1" align="center" cellpadding="2" bordercolor="#000000">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><div align="center">
      ...
      <p align="center" class="style6">Delete Record </p>
      <p>&nbsp;</p>
      
            <table width="80%" border="2" cellpadding="2" cellspacing="2">
        <tr>
          <td>ISBN</td>
          <td>Title</td>
          <td>Author</td>
        ...
        <?php do { ?>
          <tr>
			...
			<td><form id="delete_form" name="delete_form" method="post" action="">
			  <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_Recordset1['ISBN']; ?>" />
			  <label>
			    <input type="submit" name="delete_button" id="delete_button" value="Delete" onclick="return confirm('Delete this record?');"/>
			  </label>
			</form></td>
          </tr>
